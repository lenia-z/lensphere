...
const Dashboard = () => {
  return (
    <div className="w-full h-auto text-stone-100 font-light text-xs md:text-sm mt-20 py-2 flex flex-col gap-8 px-4 md:px-16 xl:px-64 pb-16 md:pb-32 md:flex-row md:justify-center">
      ...
      <div className="md:w-full xl:max-w-[64rem]">
        <Outlet />
      </div>
    </div>
  );
